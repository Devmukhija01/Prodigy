...
export const Posts = () => {
  ...
  const { data: personalTasks = [], isLoading: personalTasksLoading } = useQuery<Task[]>({
    ...
    queryFn: async () => {
      ...
      const response = await axios.get(`https://prodigy-59mg.onrender.com/api/tasks/user/${currentUserId}/personal`, { withCredentials: true });
  ...
  const { data: userGroups = [] } = useQuery<Group[]>({
    ...
    queryFn: async () => {
      if (!currentUserId) return [];
      const response = await axios.get(`https://prodigy-59mg.onrender.com/api/groups/user/${currentUserId}`, { withCredentials: true });
      return response.data;
    },
    enabled: !!currentUserId,
  });
  ...
  const { data: teamTasks = [], isLoading: teamTasksLoading } = useQuery<Task[]>({
    ...
    queryFn: async () => {
      ...
      const url = selectedTeam && selectedTeam !== 'all'
        ? `https://prodigy-59mg.onrender.com/api/tasks/user/${currentUserId}/team/${selectedTeam}`
        : `https://prodigy-59mg.onrender.com/api/tasks/user/${currentUserId}/team`;
  ...
  const createTaskMutation = useMutation({
    mutationFn: async (data: Omit<InsertTask, 'userId'>) => {
      ...
      const response = await axios.post('https://prodigy-59mg.onrender.com/api/tasks', taskData, { withCredentials: true });
  ...
  const editTaskMutation = useMutation({
    mutationFn: async ({ id, data }: { id: string; data: Partial<Task> }) => {
      ...
      const response = await axios.patch(`https://prodigy-59mg.onrender.com/api/tasks/${id}`, data, { withCredentials: true });
  ...
  const deleteTaskMutation = useMutation({
    mutationFn: async (id: string) => {
      ...
      const response = await axios.delete(`https://prodigy-59mg.onrender.com/api/tasks/${id}`, { withCredentials: true });
