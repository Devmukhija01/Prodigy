...
// import { Users, UserPlus, Search as SearchIcon, Bell, Zap, Shield, Heart } from 'lucide-react';
...
//     description: 'Send requests in one click',
//     gradient: 'from-amber-500 to-orange-500',
//   },
//   {
//     icon: Shield,
//     title: 'Privacy First',
//     description: 'You control who connects',
...
//     {
//       id: '1',
//       fromUser: { id: 'u1', username: 'sarahm', fullName: 'Sarah Miller' },
//       createdAt: new Date(Date.now() - 1000 * 60 * 30).toISOString(),
//     },
//     {
//       id: '2',
//       fromUser: { id: 'u2', username: 'alexj', fullName: 'Alex Johnson' },
//       createdAt: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString(),
//     },
//     {
//       id: '3',
//       fromUser: { id: 'u3', username: 'emilyw', fullName: 'Emily Williams' },
//       createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString(),
//     },
//     {
//       id: '4',
//       fromUser: { id: 'u4', username: 'michaelb', fullName: 'Michael Brown' },
...
//         setSearchError('No user found with that ID. Please check and try again.');
//         return;
//       }
...
//         id: 'found-user',
//         username: query,
//         fullName: `${query.charAt(0).toUpperCase()}${query.slice(1)} Anderson`,
//         email: `${query.toLowerCase()}@email.com`,
//       });
//     } catch {
...
//   const handleRetryLoadRequests = useCallback(() => {
...
//       {/* Bell - shows red dot when pending */}
//       <div className="flex items-center">
//         <button
//           aria-label={`Pending requests (${pendingCount})`}
//           title="Pending requests"
//           onClick={() => setIsBellOpen(true)}
//           className="relative inline-flex items-center justify-center w-10 h-10 rounded-lg hover:bg-muted/30 transition"
//         >
//           <Bell className="w-5 h-5" />
//           {/* red dot */}
//           {pendingCount > 0 && (
//             <span
//               className="absolute -top-0.5 -right-0.5 inline-flex h-3 w-3 items-center justify-center rounded-full bg-red-600 ring-2 ring-white"
//               aria-hidden="true"
//             />
//           )}
//         </button>
...
//                     <SearchIcon className="w-6 h-6 text-destructive" />
//                   </div>
//                   <div>
...
//           )}
//         </section>
//           {/* Pending Requests Modal (opened by bell) */}
// {isBellOpen && (
//   <div
//     role="dialog"
//     aria-modal="true"
...
//                 Pending Requests
//               </h3>
//               <p className="text-sm text-muted-foreground">{pendingCount} request{pendingCount !== 1 ? 's' : ''}</p>
//             </div>
...
//                 const from = req.fromUser ?? (req as any).from ?? {};
//                 const name = (from.firstName && from.lastName) ? `${from.firstName} ${from.lastName}` : from.fullName ?? from.username ?? from.registerId ?? 'Unknown';
...
//                       </Avatar>
//                       <div>
//                         <div className="font-medium">{from.registerId ?? from.username ?? name}</div>
...
//                       <Button
//                         onClick={() => {
//                           // close modal then accept (or keep open if you prefer)
//                           setIsBellOpen(false);
...
//                 onRetry={handleRetryLoadRequests}
//               />
//             </Card>
...
//                 icon={Users}
//                 title="All caught up!"
//                 description="You don't have any pending requests. When someone wants to connect, they'll appear here."
//                 variant="compact"
//               />
//             </Card>
//           ) : (
...
//               <Card 
//                 key={feature.title} 
//                 className="hover-elevate transition-all duration-300 group bg-card/80"
//               >
//                 <CardContent className="p-5">
...
//             Building connections, one request at a time
//           </p>
//         </footer> */}
//       </div>
//     </div>
...
export default function FriendsManagement() {
  ...
  const { data: searchedUser, isFetching: isSearchingUser, error: searchApiError } = useQuery({
    ...
    queryFn: async () => {
      const res = await apiRequest('GET', `/api/user/search?registerId=${encodeURIComponent(debounced)}`);
      if (!res.ok) {
