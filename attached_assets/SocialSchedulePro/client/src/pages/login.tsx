      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Sign in to your SocialFlow account</p>
          </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          <div className="relative z-10 text-center text-white px-12 max-w-lg">
            <div className="mb-8">
              ...
              <div className="inline-block p-6 bg-white/10 rounded-2xl backdrop-blur-sm border border-white/20 shadow-2xl">
                <div className="w-16 h-16 bg-gradient-to-br from-white to-white/80 rounded-xl flex items-center justify-center transform rotate-12 shadow-lg">
                  <div className="text-indigo-600 font-bold text-2xl">SF</div>
                </div>
              </div>
            </div>
            ...
            <p className="text-lg text-white/90 mb-8 leading-relaxed">
              Join thousands of content creators who trust SocialFlow to manage their social media presence across all platforms.
            </p>
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="flex items-center p-4 bg-white/10 rounded-lg backdrop-blur-sm">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-white/80">Track performance and engagement</div>
                </div>
              </div>
