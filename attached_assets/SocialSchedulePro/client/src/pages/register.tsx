      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-emerald-50 to-teal-100">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Join SocialFlow and start managing your social media</p>
          </div>
              ...
              <div className="inline-block p-8 bg-white/10 rounded-3xl backdrop-blur-sm border border-white/20 shadow-2xl">
                <div className="relative">
                  <div className="w-20 h-20 bg-gradient-to-br from-white to-white/80 rounded-2xl flex items-center justify-center transform -rotate-12 shadow-xl">
                    <div className="text-teal-600 font-bold text-3xl">SF</div>
                  </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-center space-x-8">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm font-medium">Track Analytics</div>
                </div>
                <div className="text-center">
